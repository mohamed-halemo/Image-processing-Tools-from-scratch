...
from GuiT6 import Ui_MainWindow
import sys
            ...
            if self.Bool == 0:
                ...
                if kernelsize % 2 == 0 or kernelsize == 1 or kernelsize2 > (image.shape[0]*image.shape[1]):
                    ...
                    if self.BOOL_Blured == 1:
                        # xImgShape, yImgShape = self.Blured_Normal.shape

                        # if(yImgShape % 2 == 0):
                        #     self.Blured_Normal = np.vstack(
                        #         (self.Blured_Normal, self.Blured_Normal[xImgShape-1, :]))
                        # if(xImgShape % 2 == 0):
                        #     self.Blured_Normal = np.c_[
                        #         self.Blured_Normal, self.Blured_Normal[:, yImgShape-1]]
