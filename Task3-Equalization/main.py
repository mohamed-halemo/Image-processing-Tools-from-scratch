...
from GuiT33 import Ui_MainWindow
import sys
...
class ApplicationWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.fix_img=0
        self.NormalizeHistogramBtn=self.ui.NormalizeHBtn
        ...
        self.NormalizeHistogramBtn.clicked.connect(self.NormalizeHistogram)
        ...
        self.Histogram=[]
        self.ImageHistoTab=self.ui.Image_TabHisto
        self.fig7,self.ax7 = plt.subplots(1,1)
        self.lay7=QtWidgets.QVBoxLayout(self.ImageHistoTab)
        self.plotWidget7=FigureCanvas(self.fig7)
        self.lay7.addWidget(self.plotWidget7)
    def Browse(self):
        FileName=QtWidgets.QFileDialog.getOpenFileName(self,"Open File","E:\\Year3 Term1\\Image Processing\\Task3","All Files (*);;PNG Files (*.png);;Tif Files (*.tif);;Jpg Files(*.jpg);; Bmp Files(*.bmp)")
...
#    cumulative=((cumulative-cumulative.min())*255)/(cumulative.max()-cumulative.min())
#         cumulative=cumulative.astype('uint8')
#         im=im.astype(int)

#         flat=im.flatten()
#         EqualizedImg=cumulative[flat]
#         EqualizedImg=np.reshape(EqualizedImg,im.shape)
#         self.ax6.imshow(EqualizedImg,cmap='gray')
        
#         self.show()
#         self.fig6.canvas.draw()
#         self.NormalizeHistogram(EqualizedImg,1)
##########################################################################################################
